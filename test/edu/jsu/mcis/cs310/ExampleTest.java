...
public class ExampleTest {
    ...
    private String expectedReverseCustom;
    ...
    public void setUp() {
        ...
        expectedReverseCustom = "rorre detarebiled si sihT";
    }
    ...
    public void testReverseCustomMessage() {
        String actual = main.reverse("This is deliberated error");
        assertEquals(expectedReverseCustom, actual);
    }
